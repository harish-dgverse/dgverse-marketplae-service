...
-- AddForeignKey
ALTER TABLE `nft` ADD CONSTRAINT `nft_wallet_address_fkey` FOREIGN KEY (`wallet_address`) REFERENCES `wallet`(`wallet_address`) ON DELETE RESTRICT ON UPDATE CASCADE;
