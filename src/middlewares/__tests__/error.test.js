...
describe('Error middlewares', () => {
  ...
  describe('Error handler', () => {
    ...
    test('should put the error stack in the response if in dev mode', () => {
      config.env = 'dev';
      const error = new ApiError(httpStatus.BAD_REQUEST, 'Any error');
      const res = httpMocks.createResponse();
      const sendSpy = jest.spyOn(res, 'send');
    ...
    test('should send internal server error status and message if in prod mode and error is not operational', () => {
      config.env = 'prod';
    ...
    test('should preserve original error status and message if in prod mode and error is operational', () => {
      config.env = 'prod';
      const error = new ApiError(httpStatus.BAD_REQUEST, 'Any error');
      const res = httpMocks.createResponse();
      const sendSpy = jest.spyOn(res, 'send');
